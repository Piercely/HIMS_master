	...
	<form id="costForm">
		<table>
			...
			<tr>
				...
				<td>
					<p class="short-input ue-clear">
						<label>缴费方式：</label> <input type="text" name="type" id="types"
			...
			<tr>
				...
				<td>
					<p class="short-input ue-clear">
						<input type="text" name="userId" readonly readonly id="userId" value="${sessionScope.loginUser.userId}" />
					</p>
				</td>
				<td>
					<p class="short-input ue-clear">
				...
				<td>
					<p class="short-input ue-clear">
						<input type="text" name="userName" readonly id="userName" value="${sessionScope.loginUser.userName}"/>
					<p class="short-input ue-clear">
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<p class="short-input ue-clear">
						<input type="text" name="costTime" readonly
							   id="collectionTime" />
					<p class="short-input ue-clear">
				</td>
			</tr>
