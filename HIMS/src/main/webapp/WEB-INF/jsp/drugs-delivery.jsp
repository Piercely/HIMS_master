...
<body>
		...
		<form id="drugs_delivery">
			<table>
				<tr>
					...
					<td>
						<p class="short-input ue-clear">
							<input results="s" type="search" readonly name="patientId"
								id="patientId" />
						</p>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						<p class="short-input ue-clear">
							<input type="search" results="s" readonly name="drugId"
								id="drugsId" />
						</p>
					</td>
					<td>
					...
					<td>
						<p class="short-input ue-clear">
							<input type="text" name="drugCount" id="num" onblur="checkdrugsnum()" />
				...
				<tr>
					...
					<td>
						<p class="short-input ue-clear">
							<input type="text" readonly name="drugName" id="drugsName" />
						</p>
					</td>
					...
					<td>
						<p class="short-input ue-clear">
							<input type="text" readonly name="drugPrice" id="price" />
						<p class="short-input ue-clear">
					</td>
				</tr>
			</table>
	...
	<div class="btn">
		<a href="javascript:;" class="confirm">发放</a> <a href="javascript:;"
			class="clear">重置</a>
	</div>
